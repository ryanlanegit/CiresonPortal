...
define(function (require) {
    var longStringTemplate = require('text!CustomSpace/Scripts/forms/fields/longstring/view.html');
    ...
    var definition = {
        ...
        build: function build (vm, node, callback) {            
            ...
            var getFieldViewModel = function getFieldViewModel (properties) {
                var fieldProperties = {
                    ...
                    TextCounter: function textCounter (e) {                                        
